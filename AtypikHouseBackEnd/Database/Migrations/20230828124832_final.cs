        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activity_Adverts_AdvertId",
                        column: x => x.AdvertId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commentarys_Adverts_AdvertId",
                        column: x => x.AdvertId,
                        principalTable: "Adverts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CriteriaAdvert", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CriteriaAdvert_Adverts_AdvertId",
                        column: x => x.AdvertId,
                        principalTable: "Adverts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CriteriaAdvert_Criterias_CriteriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentTimer = table.Column<string>(type: "text", nullable: false),
                    AdvTenants = table.Column<int>(type: "integer", nullable: false),
                    DelTenant = table.Column<bool>(type: "boolean", nullable: false),
                    DelOwner = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CriteriaAdvert_AdvertId",
                table: "CriteriaAdvert",
                column: "AdvertId");

            migrationBuilder.CreateIndex(
                name: "IX_CriteriaAdvert_CriteriaId",
                table: "CriteriaAdvert",
                column: "CriteriaId");
