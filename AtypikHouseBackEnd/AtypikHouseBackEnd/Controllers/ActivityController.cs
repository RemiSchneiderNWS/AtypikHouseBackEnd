...
namespace AtypikHouseBackEnd.Controllers
{
    ...
    public class ActivityController : Controller
    {
        ...
        [HttpGet("getActivityByAdvert/{idAdvert}")]
        public ActionResult<IEnumerable<Activity>> getActivityByAdvert( int idAdvert)
        {
            IEnumerable<Activity> activities  = Activities.getActivityByAdvertId(idAdvert);
            if(activities.Count() == 0)
            {
                return NotFound("aucune activitée trouvée");
            }
